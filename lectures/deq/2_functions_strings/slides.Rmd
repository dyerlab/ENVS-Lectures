...
There is also a great [CHEATSHEET](https://evoldyn.gitlab.io/evomics-2018/ref-sheets/R_strings.pdf) for this library, go take a look!  And then bookmark the site.
...
Goal: Take the string below and find most common word (note: this runs off the side because there is not wrapped)
...
1. Get data
2. Remove punctuation using (`gsub("[[:punct:]]","",aboutDEQ))`; more in the regex slides).
3. Make it lowercase
