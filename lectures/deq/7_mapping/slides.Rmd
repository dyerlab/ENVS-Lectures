...
# 15 Minute Activity - Interactive Map

Make a new R file in the same folder as the project named `leaflet_examples.R`.  In this file, 

1. Load in the contentsof the `GIS_Data.csv` using `read_csv()` from `tidyverse`.  By now, you should be getting the handle of this, make sure to import the proper libraries, including `library(leaflet)`.  Name the variable you assign these data `Stations`.
