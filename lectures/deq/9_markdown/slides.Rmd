...
## Final Activity - Make a Quick Report
...
Make sure to provide an example of at least one each of the following items:

1. Some Graphical Output

2. A Table of results.

3. In-text interpretation of R output (e.g., inline R code)
