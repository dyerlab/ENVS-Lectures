...
slides <- paste("<a href='", 
                ...
                "' class='w3-button w3-round-large w3-orange'>Slides</a>", sep="")
narriative <- paste("<a href='",
                    paste(files,"narriative.nb.html", sep="/"),
                    "' class='w3-button w3-round-large w3-blue'>Narriative</a>", sep="")
...
df <- data.frame( Topic=titles,
                  Connections =  paste( video,slides, narriative, homework, sep=" " )
                 )

# fix a few special cases
df$Topic[ which( df$Topic == "Ggplot") ] <- "GGPlot"
