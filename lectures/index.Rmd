...
Here are some lectures that mix together some of the above activities that I've developed to teach a graduate and postgraduate workshop in *Landscape Genetics*.

```{r}
files <- list.dirs( path="landscape_genetics", recursive=FALSE )
