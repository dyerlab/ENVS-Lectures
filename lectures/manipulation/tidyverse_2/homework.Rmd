...
This homework focuses on how we can use <tt>tidyverse</tt> routines to become more effective in our pre-treatment of data.  As a reminder, the operative *verbs* we use in data preparation include:
