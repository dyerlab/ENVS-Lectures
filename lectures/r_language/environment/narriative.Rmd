...
One of the most important components of the `R` ecosystem is that it is extensible by its users, like you and me.  The base functionality of `R` is defined by a few packages that are installed along with the base system.  To add functionality to `R`, we can install additional packages that offer special functionalities.
